...
INSTALLED_APPS = [
    ...
    'serviceform_app.serviceform',
    'serviceform_app.tasks',
...
MIDDLEWARE_CLASSES = [
    ...
    'serviceform_app.serviceform.utils.ClearParticipantCacheMiddleware',
    'serviceform_app.serviceform.utils.InvalidateCachalotAfterEachRequestMiddleware'
]
