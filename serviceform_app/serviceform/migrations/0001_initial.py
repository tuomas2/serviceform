...
import serviceform_app.serviceform.models
import serviceform_app.serviceform.utils
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            bases=(serviceform_app.serviceform.models.SubitemMixin, models.Model),
        ),
        migrations.CreateModel(
            name='ActivityChoice',
            fields=[
        ...
        migrations.CreateModel(
            ...
            bases=(serviceform_app.serviceform.models.CopyMixin, models.Model),
        ),
        migrations.CreateModel(
            name='FormRevision',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, verbose_name='Description')),
                ('order', models.PositiveIntegerField(db_index=True, default=0, verbose_name='Order')),
                ('background_color', serviceform_app.serviceform.models.ColorField(blank=True, null=True, verbose_name='Background color')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('secret_key', models.CharField(db_index=True, default=serviceform_app.serviceform.utils.generate_uuid, max_length=36, unique=True, verbose_name='Secret key')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level1_color', serviceform_app.serviceform.models.ColorField(blank=True, help_text='If left blank (black), default coloring will be used', null=True, verbose_name='Level 1 category default background color')),
                ('level2_color', serviceform_app.serviceform.models.ColorField(blank=True, help_text='If left blank (black), it will be derived from level 1 background color', null=True, verbose_name='Level 2 category default background color')),
                ('activity_color', serviceform_app.serviceform.models.ColorField(blank=True, help_text='If left blank (black), it will be derived from level 2 background color', null=True, verbose_name='Activity default background color')),
